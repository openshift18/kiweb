...
router.get('/', function (req, res, next) {
    ...
    db.createLager(function () {
        db.selectLagerScore(function (score) {
            score.sort(sort)
...
router.post('/', function (req, res, next) {
    ...
    //console.log(points)
    db.insertLagerScore(points, function () {
        db.insertLagerRaw(JSON.stringify(rawData), req.body.time, function () {
            res.send({state: true})
        })
    })
});
