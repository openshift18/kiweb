...
router.get('/', function (req, res, next) {
    ...
    db.createAuto(function () {
        db.selectAutoScore(function (score) {
            score.sort(sort)
...
router.post('/', function (req, res, next) {
    ...
    //console.log(points)
    db.insertAutoScore(points, function () {
        db.insertAutoRaw(JSON.stringify(rawData), req.body.time, function () {
            res.send({state: true})
        })
    })
});
